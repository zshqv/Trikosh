...
def upsert_market_data(ticker, market):
    conn = get_connection()
    cur = conn.cursor()
...
def upsert_income_statement(ticker, fiscal_year, income):
    conn = get_connection()
    cur = conn.cursor()
...
def upsert_balance_sheet(ticker, fiscal_year, balance):
    conn = get_connection()
    cur = conn.cursor()
...
def upsert_cash_flow(ticker, fiscal_year, cashflow):
    conn = get_connection()
    cur = conn.cursor()
...
def upsert_ratios(ticker, fiscal_year, ratios):
    conn = get_connection()
    cur = conn.cursor()
