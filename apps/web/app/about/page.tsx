    ...
    <div style={{ backgroundColor: 'var(--bg-base)', minHeight: '100vh' }}>
      <div style={{ maxWidth: '680px', margin: '0 auto', padding: '40px 24px 80px' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '20px', marginBottom: '48px' }}>
          ...
          <p style={{ fontFamily: 'var(--font-sans)', fontSize: '15px', color: 'var(--text-secondary)', lineHeight: 1.75 }}>
            The platform is not trying to replace Bloomberg. It is trying to give finance students and CFA candidates the baseline they need to start doing real research — not scraping data from tables in PDFs, but actually asking analytical questions about businesses. The 50 companies in the coverage universe were chosen for their analytical clarity, not their market cap. They are the companies that best illustrate how their sectors work.
          </p>
          <p style={{ fontFamily: 'var(--font-sans)', fontSize: '15px', color: 'var(--text-secondary)', lineHeight: 1.75 }}>
