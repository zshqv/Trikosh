...
const STEPS: Step[] = [
  ...
  },
  {
    ...
    checklist: [
      ...
      'Identify what the market is currently rewarding: high-growth names at premium multiples vs. mature names at value multiples',
    ],
  ...
  },
  {
    ...
    body: [
      ...
      'Pay particular attention to trend, not just level. A gross margin declining from 65% to 55% over five years is a serious warning sign even if 55% is still good in absolute terms. Compression tells you something structural is changing — pricing power is eroding, input costs are rising, or competition is intensifying.',
    ],
    checklist: [
  ...
  },
  {
    ...
    tagColor: '#DC2626',
    body: [
      'Relative valuation is the most widely used valuation methodology in practice, precisely because it is grounded in observable market prices rather than assumptions about the future. When a sector trades at 15x EBITDA on average and your subject company trades at 9x, the market is telling you something — your job is to understand whether it is cheap or whether the discount is deserved.',
      'The three multiples you must compute are EV/Revenue, EV/EBITDA, and Price-to-Earnings. Use Enterprise Value based multiples to compare companies with different capital structures. P/E is useful for equity-to-equity comparisons but is distorted by leverage and one-time items.',
    ...
    checklist: [
      ...
      'Apply the median multiple to your subject company metrics to derive an implied valuation range',
  ...
  },
  {
    ...
    checklist: [
      ...
      'Build a sensitivity table: WACC +/-1% vs. Terminal Growth Rate +/-0.5%',
  ...
  },
  {
    ...
    body: [
      ...
      'A professional equity research note has a structure refined over decades. It begins with the investment thesis — one sentence stating your recommendation and the primary reason. It then presents the bull case and the bear case with equal rigour. The analyst\'s job is not to be a cheerleader; it is to present the evidence and draw a reasoned conclusion.',
      'Your research note should end with a clear valuation conclusion: a price target derived from your DCF and comps analysis, a rating (Buy / Hold / Sell), and the key catalyst you expect to move the stock toward your target.',
    ],
    checklist: [
      ...
      'Have someone who does not know the company read your thesis — if they are confused, rewrite it',
    ],
  },
]
...
const SECTOR_RATIOS: Record<string, { primary: string[]; avoid: string[] }> = {
  ...
  'AI & Technology': {
    ...
    avoid: ['Debt/EBITDA (often negative in growth phase)', 'Asset Turnover (low for SaaS)'],
  },
  'Healthcare': {
    primary: ['Gross Margin', 'R&D as % Revenue', 'Operating Margin', 'Interest Coverage', 'EV/EBITDA'],
    avoid: ['Asset Turnover (capital intensive)', 'Same-store sales metrics'],
  },
  'Consumer & Retail': {
    ...
    <div style={{ backgroundColor: 'var(--bg-base)', minHeight: '100vh' }}>
      <div style={{ maxWidth: '900px', margin: '0 auto', padding: '48px 24px' }}>
        ...
        <div style={{ marginBottom: '48px' }}>
          ...
          <div style={{ marginTop: '32px', borderBottom: 'var(--border-rest)' }} />
        </div>
        ...
        <div style={{ marginBottom: '48px' }}>
          ...
          <p style={{
            ...
            Not all 15 ratios carry equal weight in every sector. Select your sector below.
          </p>
              ...
              <div>
                ...
                {SECTOR_RATIOS[activeSector].primary.map(r => (
                  <div key={r} style={{
                    ...
                    <span style={{ color: '#059669', fontWeight: 700 }}>checkmark</span> {r}
                  </div>
                ))}
              </div>
              <div>
          ...
          {STEPS.map((step, idx) => {
            ...
            return (
              <div
                ...
                style={{
                  backgroundColor: 'var(--bg-surface-1)',
                  border: isOpen ? `1px solid ${step.tagColor}55` : 'var(--border-rest)',
                  borderRadius: '10px',
                  overflow: 'hidden',
                }}
              >
